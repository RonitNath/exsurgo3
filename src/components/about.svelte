...
<section id="About" class=" border-b py-8 bg-gradient-to-t from-white to-orange-400" >
    <div class="container max-w-5xl mx-auto m-8 ">
        ...
        <div class="flex flex-wrap">
            <div class="w-5/9 sm:w-1/2 p-6">
                <h3 class="text-4xl text-gray-800 font leading-relaxed mb-2 text-center font-bold">
                Who is this for? </h3>
                <h3 class="text-3xl text-gray-800 font leading-2 mb-3 text-center">
                    Anyone curious about business. <br>Future business students. <br>Future entrepreneurs.
                </h3>
